    ...
    offset(r = 1.0)
        offset(delta = -1.0)
            union() {
                ...
                hull() {
                    translate([-11.4, 27.6]) scale([1.05, 0.95]) circle(r = 5.5);
                    translate([-18.2, 21.8]) scale([0.98, 1.12]) circle(r = 5.9);
                }
                ...
                hull() {
                    translate([0, 36.0]) circle(r = 2.6);
                    translate([0, hole_y]) circle(r = 4.1);
                }
            }
}
